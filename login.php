<?php
 ...
 if(isset($_COOKIE['email'])){
     ...
     //if credentials are invalid program redirects to clear cookies through logout.php and sends user back to index.php
	 if(!$row = $result -> fetch_assoc()){
        header("location: logout.php");
    }else{    
        //if the creditentials are legitimate then the user will automatically be sent to there profile page
		header("location: userProfile.php"); 
    } 
 }else{
    //if the user has no cookies set then the program will verify their credentials and set cookies
