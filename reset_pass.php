					...
					<div id="content">
						<?php
							...
							if($newpass == $newpass1) {
								...
								echo "
									<h2><strong>Password Reset successful</strong></h2>
									Your password has been successfully updated.<p>To return to the login page, <a href='index.php'>Click here</a>
								";
							}
							...
							// If passwords do not match
								...
								echo "
									<h2><strong>Password Reset unsuccessful</strong></h2>
									Passwords do not match. <a href='recover.php?code=$code&email=$post_email'>Click here to return and try again.</a>
								";
							}
						?>
					</div>
